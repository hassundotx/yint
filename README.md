...
The repository is now laid out as a desk. Copy or mount it as `/=yint=` on a
current Urbit ship. Copy the data in `data/` somewhere accessible. You should
be able to then start the `%yint` app, and load phrases and a world.
